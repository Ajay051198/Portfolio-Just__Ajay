      ...
      {isLoading ? (
        ...
        <div className="container">
          ...
          <div className="text">
            ...
            <span className="white">University of British Columbia</span>, Canada.
            I’m practising to be an AI developer with most of my work focused on
            machine learning, data science and IoT systems. My time spent not
            writing code is spent consuming non-fiction books, podcasts (huge
            fan of Joe Rogan) or working out in the gym. I also develop websites
            ...
            Ltd. Once I realised my interest lies in data and AI, I decided to
